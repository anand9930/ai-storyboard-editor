...
export function NodeInputPanel({
  ...
  return (
    <div className="bg-zinc-900/95 backdrop-blur border border-zinc-800 rounded-xl p-4 shadow-xl w-[500px]">
      ...
      {connectedImage && (
        <div className="flex gap-2 mb-3">
          <div className="relative w-12 h-12 rounded-lg overflow-hidden border border-zinc-700">
            ...
            />
            <span className="absolute top-0 right-0 bg-zinc-800 text-[10px] text-zinc-400 px-1 rounded-bl">
              1
            </span>
          </div>
        </div>
      ...
      <textarea
        ...
        className="w-full bg-transparent text-sm text-zinc-300 placeholder:text-zinc-600 resize-none focus:outline-none min-h-[60px]"
        rows={2}
        ...
        <div className="flex items-center gap-3">
          ...
          {nodeType === 'image' && (
            <div className="flex items-center gap-1 bg-zinc-800 px-2 py-1 rounded-lg">
              ...
              <span className="text-sm text-zinc-300">Auto</span>
            </div>
          )}
        </div>
